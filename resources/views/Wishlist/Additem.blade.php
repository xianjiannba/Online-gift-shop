        ...
        @foreach($data as $val)
            <div class="item">
                <div class="card">
                    ...
                    <form action="additem">
                        <input type="text" style="display: none;" name='Item' value="{{$val->Item}}">
                        <input type="text" style="display: none;" name='Id' value="{{$val->Id}}">
                        <input type="text" style="display: none;" name='Price' value="{{$val->Price}}">
                        <div class="flex footer">
                            <div class="flex amount">Amount<input type="text" name="amount"></div>
                        </div>
